variable "template_type" {
  type        = string
  description = "Proxmox template name or VMID to clone from for NTP VMs"
...
variable "vm_count" {
  type        = number
  default     = 2
  description = "Number of NTP VMs to create"
...
variable "start_vmid" {
  type        = number
  default     = 600
  description = "Starting VMID for the first NTP VM (Proxmox allows 100-999999999)"
