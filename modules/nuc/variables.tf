variable "template_type" {
  type        = string
  description = "Proxmox template name or VMID to clone from for NUC VMs"
...
variable "vm_count" {
  type        = number
  default     = 3
  description = "Number of NUC VMs to create"
...
variable "start_vmid" {
  type        = number
  default     = 500
  description = "Starting VMID for the first NUC VM (Proxmox allows 100-999999999)"
