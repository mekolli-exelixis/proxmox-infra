variable "template_type" {
  type        = string
  description = "Proxmox template name or VMID to clone from for DHCP VMs"
...
variable "vm_count" {
  type        = number
  default     = 2
  description = "Number of DHCP VMs to create"
...
variable "start_vmid" {
  type        = number
  default     = 700
  description = "Starting VMID for the first DHCP VM (Proxmox allows 100-999999999)"
